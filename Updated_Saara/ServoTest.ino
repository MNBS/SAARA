...
void hm1move()
{
  if (joystickY > 600)
  {
    if (hm1Test > 1000 && hm1Test < 2300 || hm1pos <= 1000)
    {
      hm1Test += 1;
      hm1.write(hm1Test);
  ...
  {
    if (hm1Test > 1000 && hm1Test < 2300 || hm1pos >= 2300)
    {
      hm1Test -= 1;
      hm1.write(hm1Test);
      delayMicroseconds(5000);
...
void leftRight()
{
  (joystickX > 850 || joystickX < 300) ? speed = 800: speed = 1600;
  if (joystickX > 600)
  {
...
void powerOn(){ 
  ...
  // }
    ...
    while (em1Count < 4000)
    {
      ...
      if (em1Count < 4000) digitalWrite(em1.pin, HIGH);
      delayMicroseconds(600);
      // if (em1Count < 1800) digitalWrite(sm2.pin, LOW);
      if (em1Count < 4000) digitalWrite(em1.pin, LOW);
      delayMicroseconds(600);
      em1Count++;
    }     
    // while (timer < 1)
