// Source code for prototype 1 of SAARA

/* Library used for SAARA:
wire.h - accelerometer(Unused)
Servo.h - Servo Library
EEPROM.h - Memory Library
Adafruit_NeoPixel.h - LED library
*/
#include <Wire.h>
#include <Servo.h>
#include <EEPROM.h>
...
// Line 24 - 36 is for EEPROM address
...
// Button declaration along with pin number that is connected to Arduino(Line 39 - 42)
#define HOME_BUTTON 24
#define DRINK_BUTTON 26
#define POWER_BUTTON 22
#define DOOR_BUTTON 23

//Relay pin is connected to pin 12 of Arduino
int relayPin = 12;

//Proximity pin is connected to pin 9 of Arduino
int prox = 9; 

/* upDownCount is to calculate the steps taken in relative to home position which is stored
   in upDownCountAddress and upDownCountAddress2*/ 
int dir;
float upDownCount;
int upDownCountHome, upDownCountHome2;

/* Totalpower, totalhomeCorrection and drinkTotalCorrection is for the maximum steps that are taken between the 4 motors when turning on,
going to home and going to drink correction*/
...
void loop()
{
  Serial.println(hm1Test);
  // Serial.println(digitalRead(prox));
  // Serial.println(hm1pos);
  // Serial.println(joystickY);
  // Serial.print("POWER_BUTTON: ");Serial.print(digitalRead(POWER_BUTTON));
  // Serial.print("  HOME_BUTTON: ");Serial.print(digitalRead(HOME_BUTTON));
  // Serial.print("  DRINK_BUTTON:");Serial.print(digitalRead(DRINK_BUTTON));
