...
void loop()
{
  ...
  {    
    ...
    if (joystick)
    {
      ...
      {
        pixels.setPixelColor(0, pixels.Color(0,10,10)); // Moderately bright green color.
        pixels.show();
        pixels.setPixelColor(1, pixels.Color(0,10,10)); // Moderately bright green color.
        pixels.show();
        pixels.setPixelColor(2, pixels.Color(0,10,10)); // Moderately bright green color.
        pixels.show();
        pixels.setPixelColor(3, pixels.Color(0,10,10)); // Moderately bright green color.
        pixels.show();
        pixels.setPixelColor(4, pixels.Color(0,10,10)); // Moderately bright green color.
    ...
    else
    {
      ...
      while (hm1Led < 1){
        ...
        pixels.show(); // This sends the updated pixel color to the hardware.
        pixels.setPixelColor(3, pixels.Color(0,0,10)); // Moderately bright green color.
        pixels.show(); // This sends the updated pixel color to the hardware.
        pixels.setPixelColor(4, pixels.Color(0,0,10)); // Moderately bright green color.
        pixels.show(); // This sends the updated pixel color to the hardware.
        hm1Led +=1; 
      } 
      em2move();
  ...
  { 
    ...
    if (joystick)
    {
      ...
      {
        pixels.setPixelColor(0, pixels.Color(4,10,0)); // Moderately bright green color.
        pixels.show();
        pixels.setPixelColor(1, pixels.Color(4,10,0)); // Moderately bright green color.
        pixels.show();
        pixels.setPixelColor(2, pixels.Color(4,10,0)); // Moderately bright green color.
        pixels.show();
        pixels.setPixelColor(3, pixels.Color(4,10,0)); // Moderately bright green color.
        pixels.show();
        pixels.setPixelColor(4, pixels.Color(4,10,0)); // Moderately bright green color.
        pixels.show(); // This sends the updated pixel color to the hardware.
      }
      maxReach();
    }
    else
    {
      ...
      while (fwdBkLed < 1){
        ...
        pixels.show(); // This sends the updated pixel color to the hardware.
        pixels.setPixelColor(3, pixels.Color(0,10,0)); // Moderately bright green color.
        pixels.show(); // This sends the updated pixel color to the hardware.
        pixels.setPixelColor(4, pixels.Color(0,10,0)); // Moderately bright green color.
        pixels.show(); // This sends the updated pixel color to the hardware.
        fwdBkLed +=1; 
      } 
      fwdBk();
  ...
  // Serial.print("fwdBkLed: ");Serial.print(fwdBkLed);Serial.print(" upDownLed: ");Serial.print(upDownLed);Serial.print(" gripperLed: ");
  // Serial.print(gripperLed);Serial.print(" hm1Led: ");Serial.println(hm1Led);
}
...
void upDown(){
  if (joystickY > 600 && upDownCount >= 0){
    ...
    {
      if ((hm1Test > 1000 && hm1Test < 2300) || hm1Test >= 2300)
      {
        hm1Test -= 3;
    ...
    if (em2.step > -1072 && em2.step < 1072)
    {
      if ((hm1Test > 1000 && hm1Test < 2300) || hm1Test <= 1000)
      {
        hm1Test += 3;
        hm1.writeMicroseconds(hm1Test);
        delayMicroseconds(10);
...
void powerOn(){ 
  digitalWrite(relayPin, HIGH);
    ...
    while (em1Count < 3200)
    {
      if (em1Count < 3200) digitalWrite(em1.pin, HIGH);
      delayMicroseconds(600);
      if (em1Count < 3200) digitalWrite(em1.pin, LOW);
      delayMicroseconds(600);
      em1Count++;
    }     
    while (hm1count < 1800){
